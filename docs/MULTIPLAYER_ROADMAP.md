...
**Status:** ROADMAP APPROVED 2026-07-19 · **Phase MP3 COMPLETE** (Fable gate PASS 2026-07-19, tag `beacon-3`; MP2 `beacon-2`; MP1 `beacon-1`; MP0 `beacon-0`) · next: MP4 · Tags: `beacon-0` … `beacon-9` + `v2.0.0`
...
| MP4 | Local multi-client co-op | Opus | Fable | beacon-4 | 🔨 BUILD COMPLETE 2026-07-19 (A–D landed; Opus) — awaiting Fable gate. Local co-op works: two tabs share a world over BroadcastChannel (join · mirror · host-authoritative move · emote/say bubbles · late-join). vitest 1075 · node 46 · cargo 26 · Playwright 125/125 (123 goldens byte-identical + mp-presence + mp-coop; mp-coop 3× consecutive) · eslint 0 · tsc 0 · perf 237.40/300 · v1.2.0 · FV 2 · no cache-busts. Branch point: **FREE ROAM** (roadmap default b). Scope lines: D-0 headless NPC ticking on unrendered maps → MP8; leave-detection → MP5; remote attack/act → MP6; per-map spawns → MP7. |
