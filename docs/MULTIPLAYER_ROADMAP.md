...
**Status:** ROADMAP APPROVED 2026-07-19 · **Phase MP8 COMPLETE** (Fable LOAD gate PASS 2026-07-20, tag `beacon-8`; MP7 `beacon-7`; MP6 `beacon-6`; MP5 `beacon-5`; MP4 `beacon-4`; MP3 `beacon-3`; MP2 `beacon-2`; MP1 `beacon-1`; MP0 `beacon-0`) · next: MP9 · Tags: `beacon-0` … `beacon-9` + `v2.0.0`
...
| MP9 | Safety hardening, chat, moderation, packaging, release | Opus | **Fable release gate** | beacon-9 + v2.0.0 | 🚧 **BUILD COMPLETE 2026-07-20 (Opus)** — stages A (chat+moderation) · B (packaging+safety docs) · C (Driftwood Shore co-op showcase) · D (release prep) all landed + pushed; **awaiting the Fable RELEASE gate** (which independently re-verifies every phase, signs the header verdict, and tags `beacon-9` + `v2.0.0` — NOT tagged by BUILD). Gate-ready numbers: fast `test:unit` **1290** (92 files) · net `test:net` **11/11** · node --test 48 · cargo 26 · Playwright **130/130** (128 goldens byte-identical + 2 coop-demo; perf 235.18/300) · root+server(Node+CF) tsc 0 · eslint 0 + sim wall fires · mp-i18n parity 34 (58 keys/pack) · **version 2.0.0 ×6 sites + patch-notes ?v=75** · FORMAT_VERSION 2 · both server bundles build + `beacon.mjs --help` headless. Details: docs/mp-9-spec.md. |
