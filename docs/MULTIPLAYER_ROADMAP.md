...
**Status:** ROADMAP APPROVED 2026-07-19 · **Phase MP6 COMPLETE** (Fable gate PASS 2026-07-19, tag `beacon-6`; MP5 `beacon-5`; MP4 `beacon-4`; MP3 `beacon-3`; MP2 `beacon-2`; MP1 `beacon-1`; MP0 `beacon-0`) · next: MP7 · Tags: `beacon-0` … `beacon-9` + `v2.0.0`
