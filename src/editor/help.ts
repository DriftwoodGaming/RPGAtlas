...
import { PATCH_NOTES } from "../../js/patch-notes.js?v=65";
...
<div style="display:flex;align-items:center;gap:14px;margin-bottom:10px">
  ...
  <div>
    <div style="font-size:20px;font-weight:800">RPG<span style="font-weight:300">Atlas</span> <span style="font-weight:400;font-size:14px;color:#ffd86a">1.1.0</span></div>
