    ...
    const proj = {
      ...
      classes: [
        ...
        { id: 8, name: "Sage", icon: 67, base: { mhp: 34, mmp: 26, atk: 7, def: 8, mat: 13, mdf: 12, agi: 8 },
          ...
          learnings: [{ level: 1, skillId: 2 }, { level: 3, skillId: 17 }, { level: 5, skillId: 23 }, { level: 8, skillId: 24 }] },
      ],
      skills: [
        ...
        { id: 13, name: "Flame Slash",  icon: 72,  type: "phys",  power: 30, mp: 6,  scope: "enemy",   color: "#ff8040", element: "fire", animationId: 1 },
        ...
        { id: 18, name: "Inferno",      icon: 96,  type: "magic", power: 33, mp: 15, scope: "enemies", color: "#ff7030", element: "fire", animationId: 2 },
        ...
        { id: 21, name: "Sanctuary",    icon: 115, type: "heal",  power: 24, mp: 12, scope: "allies",  color: "#f8e8b0", animationId: 3 },
        { id: 22, name: "Venom Volley", icon: 106, type: "phys",  power: 14, mp: 6,  scope: "enemies", color: "#b070d8", stateId: 1, stateChance: 45 },
        { id: 23, name: "Moonbeam",     icon: 68,  type: "magic", power: 38, mp: 11, scope: "enemy",   color: "#b0c0f8" },
